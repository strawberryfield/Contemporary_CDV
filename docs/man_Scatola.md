...
# COPYRIGHT
Casasoft Casasoft Scatola is free software:  
...
along with Casasoft Casasoft Scatola.  
If not, see <http://www.gnu.org/licenses/>.  

# DISCLAIMER
Casasoft Casasoft Scatola is distributed in the hope that it will be useful,  
